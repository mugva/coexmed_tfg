# repetim procés com amb Hs o Dp per a calcular la mitjana dels períodes de pic de l'onatge
...
var_name = 'Tp_wavedpt'
data_calc = None  # inicialitzam sa variable que contindrà els percentils
...
if res in ('s', 'S'):
    ...
    if nom_arxiu == '':
        nom_arxiu = f"percentils_{var_name}_FTS"
